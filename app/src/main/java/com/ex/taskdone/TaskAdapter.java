...
public class TaskAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        Picasso.get().load(
                "https://firebasestorage.googleapis.com/v0/b/notify-38a1e.appspot.com" +
                "/o/ProfileImages%2F" + userId.get(position) + "?alt=media&token=47eb0bd8-8" +
                        "ff0-4422-ac46-400aafa50caf")
